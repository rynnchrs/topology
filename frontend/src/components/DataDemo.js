...
export class DataDemo extends Component {
    ...
    pickListTemplate(car){
        ...
        return <div className="p-clearfix">
            <img src={process.env.PUBLIC_URL + src} alt={car.brand} style={{display:'inline-block', margin:'2px 0 2px 2px', width: '50px'}}/>
            ...
            return (
                <div className="p-grid" style={{padding: '2em', borderBottom: '1px solid #d9d9d9'}}>
                    <div className="p-col-12 p-md-3">
                        <img src={process.env.PUBLIC_URL + src} alt={car.brand}/>
                    </div>
