# Generated by Django 3.1 on 2021-03-05 08:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plate_no', models.CharField(blank=True, max_length=30, null=True)),
                ('brand', models.CharField(choices=[('M', 'Mitsubishi'), ('S', 'Suzuki'), ('F', 'Foton')], default='M', max_length=2)),
                ('release_year', models.IntegerField(blank=True, default=2020, null=True)),
                ...
                ('dealer', models.CharField(choices=[('DM', 'Diamond Motor Corporation'), ('GC', 'Grand Canyon Multi Holdings, INC.'), ('CAC', 'Cebu Autocentrale Corporation'), ('CA', 'Cherub Autodealer Inc.')], default='DM', max_length=3)),
